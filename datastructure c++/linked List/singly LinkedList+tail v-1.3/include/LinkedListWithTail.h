...
public:
    ...
    //**********************************
    //**********************************
    bool push_front(Type value){//O(1)
        node *pNewNode = new node;
        pNewNode->value = value;
        pNewNode->next = head;
        head = pNewNode;
    ...
    //**********************************
    //**********************************
    void operator = (LinkedListWithTail a){
        if( this == (&a) )
        {
            cout<<"here";
            return;
